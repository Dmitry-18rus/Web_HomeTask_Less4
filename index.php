...
$jobs = [
    [
        ...
        'month_date_begin' => 'Jan',
        'year_date_begin' => '2015',
        'month_date_compl' => 'Current',
        'year_date_compl' => '',
    ...
    [
        ...
        'month_date_begin' => 'Mar',
        'year_date_begin' => '2012',
        'month_date_compl' => 'Dec',
        'year_date_compl' => '2014',
    ...
    [
        ...
        'month_date_begin' => 'Jun',
        'year_date_begin' => '2010',
        'month_date_compl' => 'Mar',
        'year_date_compl' => '2012',
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $jobs[$j]['position'] ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$j]['month_date_begin']?> <?php echo $jobs[$j]['year_date_begin']?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $jobs[$j]['month_date_compl']?> <?php echo $jobs[$j]['year_date_compl']?></span></h6>
            <p><?php echo $jobs[$j]['description']?></p>
            <hr>
          </div>
          <?php endfor; ?>
        </div>
